...
class PuzzlebotPublisher(Node):
    ...
    El robot_state_publisher lee el URDF y se encarga de los TFs internos:
      base_footprint -> base_link -> wheel_r_link / wheel_l_link / caster_link
    """
    ...
    def __init__(self):
        ...
        self.omega = 0.5    # rad/s (velocidad angular del robot alrededor del centro)
    ...
    def timer_cb(self):
        ...
        wheel_radius = 0.05  # metros (radio aproximado de la rueda)
    ...
    def publish_odom_to_base_footprint(self, x, y, yaw):
        ...
        # transforms3d.euler.euler2quat devuelve (w, x, y, z)
